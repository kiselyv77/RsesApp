...
class VideosOtbrFragment : Fragment(), AdapterVideo.OnItemLongClickListener {

    private lateinit var videosOtbrViewModel: VideosOtbrViewModel
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        videosOtbrViewModel = ViewModelProvider(this).get(VideosOtbrViewModel::class.java)
        ...
        val root = inflater.inflate(R.layout.fragment_vodeos_otbr, container, false)
